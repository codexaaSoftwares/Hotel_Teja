...
const Rooms = () => {
  ...
  return (
    <section className="rooms-slider-section" id="rooms">
      <div className="rooms-slider-container">
        <div className="rooms-slider-header">
          <motion.h6 
            className="sub-title"
              ...
              >
                <div className="room-slide-image">
                  ...
                  <div className="room-slide-overlay">
                    <h3 className="room-slide-title">{room.title}</h3>
                    <div className="room-slide-price">From {room.price}/night</div>
                  </div>
                </div>
              </div>
            ))}
